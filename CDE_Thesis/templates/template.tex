...
\documentclass[a4paper, $if(page-layout)$$page-layout$$endif$]{templates/cdethesis}
...
\renewcommand{\universityfirst}{$university-first$}
\renewcommand{\universitysecond}{$university-second$}
...
\renewcommand{\supervisortextfirst}{$supervisor-text-first$}
\renewcommand{\supervisornamefirst}{$supervisor-name-first$}

\renewcommand{\supervisortextsecond}{$supervisor-text-second$}
\renewcommand{\supervisornamesecond}{$supervisor-name-second$}

\renewcommand{\submittedtextfirst}{$submitted-text-first$}
\renewcommand{\submittedtextsecond}{$submitted-text-second$}
...
\addcontentsline{toc}{chapter}{$declaration-heading$}
\renewcommand{\numberstyledeclaration}{plain}
$endif$

\renewcommand{\declarationtitle}{$declaration-heading$}
\begin{declaration}
	$declaration$
\end{declaration}
$endif$
